> [!NOTE]
> Read-only mirror of [`@hey-api/openapi-ts`](https://npmjs.com/package/@hey-api/openapi-ts) from the [hey-api](https://github.com/hey-api/hey-api) monorepo. Issues, pull requests, and contributions go to the [main repository](https://github.com/hey-api/hey-api).
