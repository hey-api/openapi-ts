 ...
 * Add a new pet to the store.
 */
export const addPetQuery = (options: Options<AddPetData>) => ({
 ...
 */
export const updatePetWithFormQuery = (options: Options<UpdatePetWithFormData>) => ({
 ...
 */
export const uploadFileQuery = (options: Options<UploadFileData>) => ({
 ...
 */
export const placeOrderQuery = (options?: Options<PlaceOrderData>) => ({
 ...
 */
export const createUserQuery = (options?: Options<CreateUserData>) => ({
 ...
 * Creates list of users with given input array.
 */
export const createUsersWithListInputQuery = (options?: Options<CreateUsersWithListInputData>) => ({
