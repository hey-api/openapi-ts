...
export type UserConfig = Plugin.Name<'@hey-api/client-aiohttp'> & {
  /**
...
export type Config = Plugin.Name<'@hey-api/client-aiohttp'> & {
  baseUrl: string | number | boolean;
};

export type HeyApiClientAiohttpPlugin = DefinePlugin<UserConfig, Config>;
