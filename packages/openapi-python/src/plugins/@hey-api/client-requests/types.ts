...
export type UserConfig = Plugin.Name<'@hey-api/client-requests'> & {
  /**
...
export type Config = Plugin.Name<'@hey-api/client-requests'> & {
  baseUrl: string | number | boolean;
};

export type HeyApiClientRequestsPlugin = DefinePlugin<UserConfig, Config>;
