...
export type UserConfig = Plugin.Name<'@hey-api/client-urllib3'> & {
  /**
...
export type Config = Plugin.Name<'@hey-api/client-urllib3'> & {
  baseUrl: string | number | boolean;
};

export type HeyApiClientUrllib3Plugin = DefinePlugin<UserConfig, Config>;
