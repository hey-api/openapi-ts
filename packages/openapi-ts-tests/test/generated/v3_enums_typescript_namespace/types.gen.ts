...
export namespace ModelWithEnumWithHyphen {
    export enum foo_bar_baz_qux {
        _3_0 = '3.0'
    }
}
...
export namespace ModelWithNullableString {
    /**
     * This is a simple enum with strings
     */
    export enum foo_bar_enum {
...
export namespace ModelWithNumericEnumUnion {
    /**
     * Период
     */
    export enum value {
...
export namespace ModelWithOneOfEnum {
    export enum foo {
        BAR = 'Bar'
    }
}
