...
export class Sdk {
    ...
    public export<ThrowOnError extends boolean = false>(options?: Options<ExportData, ThrowOnError>) {
    ...
    public import<ThrowOnError extends boolean = false>(options: Options<ImportData, ThrowOnError>) {
        return (options.client ?? this.client).post<ImportResponses, unknown, ThrowOnError>({
            url: '/api/v{api-version}/no+tag',
            ...options,
            headers: {
    ...
    public apiVVersionODataControllerCount<ThrowOnError extends boolean = false>(options?: Options<ApiVVersionODataControllerCountData, ThrowOnError>) {
        return (options?.client ?? this.client).get<ApiVVersionODataControllerCountResponses, unknown, ThrowOnError>({
            url: '/api/v{api-version}/simple/$count',
            ...options
        });
    }
    
    public getApiVbyApiVersionSimpleOperation<ThrowOnError extends boolean = false>(options: Options<GetApiVbyApiVersionSimpleOperationData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetApiVbyApiVersionSimpleOperationResponses, GetApiVbyApiVersionSimpleOperationErrors, ThrowOnError>({
    ...
    public deleteFoo<ThrowOnError extends boolean = false>(options: Options<DeleteFooData3, ThrowOnError>) {
        return (options.client ?? this.client).delete<unknown, unknown, ThrowOnError>({
     ...
     * @deprecated
     */
    public deprecatedCall<ThrowOnError extends boolean = false>(options: Options<DeprecatedCallData, ThrowOnError>) {
        return (options.client ?? this.client).post<unknown, unknown, ThrowOnError>({
    ...
    public getCallWithOptionalParam<ThrowOnError extends boolean = false>(options: Options<GetCallWithOptionalParamData, ThrowOnError>) {
        return (options.client ?? this.client).get<unknown, unknown, ThrowOnError>({
    ...
    public postCallWithOptionalParam<ThrowOnError extends boolean = false>(options: Options<PostCallWithOptionalParamData, ThrowOnError>) {
    ...
    public postApiVbyApiVersionRequestBody<ThrowOnError extends boolean = false>(options?: Options<PostApiVbyApiVersionRequestBodyData, ThrowOnError>) {
        return (options?.client ?? this.client).post<unknown, unknown, ThrowOnError>({
    ...
    public postApiVbyApiVersionFormData<ThrowOnError extends boolean = false>(options?: Options<PostApiVbyApiVersionFormDataData, ThrowOnError>) {
        return (options?.client ?? this.client).post<unknown, unknown, ThrowOnError>({
    ...
    public uploadFile<ThrowOnError extends boolean = false>(options: Options<UploadFileData, ThrowOnError>) {
        return (options.client ?? this.client).post<UploadFileResponses, unknown, ThrowOnError>({
    ...
    public fileResponse<ThrowOnError extends boolean = false>(options: Options<FileResponseData, ThrowOnError>) {
        return (options.client ?? this.client).get<FileResponseResponses, unknown, ThrowOnError>({
    ...
    public multipartResponse<ThrowOnError extends boolean = false>(options?: Options<MultipartResponseData, ThrowOnError>) {
        return (options?.client ?? this.client).get<MultipartResponseResponses, unknown, ThrowOnError>({
            url: '/api/v{api-version}/multipart',
            ...options
        });
    }
    
    public multipartRequest<ThrowOnError extends boolean = false>(options?: Options<MultipartRequestData, ThrowOnError>) {
        return (options?.client ?? this.client).post<unknown, unknown, ThrowOnError>({
            ...formDataBodySerializer,
            url: '/api/v{api-version}/multipart',
            ...options,
    ...
    public complexParams<ThrowOnError extends boolean = false>(options: Options<ComplexParamsData, ThrowOnError>) {
        return (options.client ?? this.client).put<ComplexParamsResponses, unknown, ThrowOnError>({
     ...
     * Login User
     */
    public putWithFormUrlEncoded<ThrowOnError extends boolean = false>(options: Options<PutWithFormUrlEncodedData, ThrowOnError>) {
        return (options.client ?? this.client).put<unknown, unknown, ThrowOnError>({
            ...urlSearchParamsBodySerializer,
            url: '/api/v{api-version}/non-ascii-æøåÆØÅöôêÊ字符串',
            ...options,
