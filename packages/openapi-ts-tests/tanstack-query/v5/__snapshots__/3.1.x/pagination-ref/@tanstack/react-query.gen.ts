...
export const getFooOptions = (options: Options<GetFooData> | typeof skipToken) => {
    ...
    return queryOptions<GetFooResponse, DefaultError, GetFooResponse, ReturnType<typeof getFooQueryKey>>({
...
export const getFooInfiniteQueryKey = (options: Options<GetFooData> | typeof skipToken): QueryKey<Options<GetFooData>> => createQueryKey('getFoo', unwrapSkipToken(options), true);
