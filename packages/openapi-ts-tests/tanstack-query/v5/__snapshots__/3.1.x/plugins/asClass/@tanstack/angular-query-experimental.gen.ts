...
export const getFooBarQueryKey = (options?: Options<GetFooBarData> | typeof skipToken) => createQueryKey('getFooBar', unwrapSkipToken(options));

export const getFooBarOptions = (options?: Options<GetFooBarData> | typeof skipToken) => {
    const unwrapped = unwrapSkipToken(options);
    return queryOptions<GetFooBarResponse, DefaultError, GetFooBarResponse, ReturnType<typeof getFooBarQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
