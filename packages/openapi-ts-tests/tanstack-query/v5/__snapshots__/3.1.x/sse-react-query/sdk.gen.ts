 ...
 * List events
 */
export const listEvents = <ThrowOnError extends boolean = false, TParseAs extends NonNullable<Config['parseAs']> = 'auto'>(options?: Options<ListEventsData, ThrowOnError, ListEventsResponses, TParseAs>): RequestResult<ListEventsResponses, unknown, ThrowOnError, 'fields', TParseAs> => (options?.client ?? client).get<ListEventsResponses, unknown, ThrowOnError, 'fields', TParseAs>({ url: '/events/list', ...options });
