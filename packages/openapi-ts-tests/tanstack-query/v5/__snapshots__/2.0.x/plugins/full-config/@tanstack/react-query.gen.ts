...
import { type DefaultError, type QueryClient, queryOptions, useMutation, type UseMutationOptions, useQuery, useQueryClient } from '@tanstack/react-query';
...
export const serviceWithEmptyTagQueryKey = (options?: Partial<Options<ServiceWithEmptyTagData>>) => createQueryKey('serviceWithEmptyTag', options);
