...
export const getFooD = (options?: Options<GetFooData> | typeof skipToken) => createQueryKey('getFoo', unwrapSkipToken(options));

export const getFooE = (options?: Options<GetFooData> | typeof skipToken) => {
    const unwrapped = unwrapSkipToken(options);
    return queryOptions<GetFooResponse, DefaultError, GetFooResponse, ReturnType<typeof getFooD>>({
...
export const getFooBarD = (options?: Options<GetFooBarData> | typeof skipToken) => createQueryKey('getFooBar', unwrapSkipToken(options));

export const getFooBarE = (options?: Options<GetFooBarData> | typeof skipToken) => {
    const unwrapped = unwrapSkipToken(options);
    return queryOptions<GetFooBarResponse, DefaultError, GetFooBarResponse, ReturnType<typeof getFooBarD>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
