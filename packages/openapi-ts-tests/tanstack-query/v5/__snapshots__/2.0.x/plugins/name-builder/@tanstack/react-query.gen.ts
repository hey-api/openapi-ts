...
export const getFooD = (options?: Partial<Options<GetFooData>>) => createQueryKey('getFoo', options);
...
export const getFooBarD = (options?: Partial<Options<GetFooBarData>>) => createQueryKey('getFooBar', options);
