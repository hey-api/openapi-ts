 ...
 * This is a simple string
 */
export const zSimpleStringWithPatternWritable = z.string().max(64).regex(/^[a-zA-Z0-9_]*$/);
 ...
 * This is a simple array with strings
 */
export const zArrayWithStringsWritable = z.array(z.string());
 ...
 * This is a type-only model that defines Date as a string
 */
export const zDateWritable = z.string();
