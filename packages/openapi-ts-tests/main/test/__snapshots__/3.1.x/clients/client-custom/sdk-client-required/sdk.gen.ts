...
export const apiVVersionODataControllerCount = <ThrowOnError extends boolean = false>(options: Options<ApiVVersionODataControllerCountData, ThrowOnError>): RequestResult<ApiVVersionODataControllerCountResponses, unknown, ThrowOnError> => options.client.get<ApiVVersionODataControllerCountResponses, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple/$count', ...options });

export const getApiVbyApiVersionSimpleOperation = <ThrowOnError extends boolean = false>(options: Options<GetApiVbyApiVersionSimpleOperationData, ThrowOnError>): RequestResult<GetApiVbyApiVersionSimpleOperationResponses, GetApiVbyApiVersionSimpleOperationErrors, ThrowOnError> => options.client.get<GetApiVbyApiVersionSimpleOperationResponses, GetApiVbyApiVersionSimpleOperationErrors, ThrowOnError>({ url: '/api/v{api-version}/simple:operation', ...options });

export const deleteCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<DeleteCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.delete<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const getCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<GetCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.get<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const headCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<HeadCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.head<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const optionsCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<OptionsCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.options<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const patchCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<PatchCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.patch<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const postCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<PostCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.post<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const putCallWithoutParametersAndResponse = <ThrowOnError extends boolean = false>(options: Options<PutCallWithoutParametersAndResponseData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.put<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/simple', ...options });

export const deleteFoo = <ThrowOnError extends boolean = false>(options: Options<DeleteFooData3, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.delete<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/foo/{foo_param}/bar/{BarParam}', ...options });

export const callWithDescriptions = <ThrowOnError extends boolean = false>(options: Options<CallWithDescriptionsData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.post<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/descriptions', ...options });
...
export const callWithDefaultOptionalParameters = <ThrowOnError extends boolean = false>(options: Options<CallWithDefaultOptionalParametersData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.post<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/defaults', ...options });

export const callToTestOrderOfParams = <ThrowOnError extends boolean = false>(options: Options<CallToTestOrderOfParamsData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.put<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/defaults', ...options });

export const duplicateName = <ThrowOnError extends boolean = false>(options: Options<DuplicateNameData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.delete<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/duplicate', ...options });

export const duplicateName2 = <ThrowOnError extends boolean = false>(options: Options<DuplicateName2Data, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.get<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/duplicate', ...options });

export const duplicateName3 = <ThrowOnError extends boolean = false>(options: Options<DuplicateName3Data, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.post<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/duplicate', ...options });

export const duplicateName4 = <ThrowOnError extends boolean = false>(options: Options<DuplicateName4Data, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.put<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/duplicate', ...options });

export const callWithNoContentResponse = <ThrowOnError extends boolean = false>(options: Options<CallWithNoContentResponseData, ThrowOnError>): RequestResult<CallWithNoContentResponseResponses, unknown, ThrowOnError> => options.client.get<CallWithNoContentResponseResponses, unknown, ThrowOnError>({ url: '/api/v{api-version}/no-content', ...options });

export const callWithResponseAndNoContentResponse = <ThrowOnError extends boolean = false>(options: Options<CallWithResponseAndNoContentResponseData, ThrowOnError>): RequestResult<CallWithResponseAndNoContentResponseResponses, unknown, ThrowOnError> => options.client.get<CallWithResponseAndNoContentResponseResponses, unknown, ThrowOnError>({ url: '/api/v{api-version}/multiple-tags/response-and-no-content', ...options });

export const dummyA = <ThrowOnError extends boolean = false>(options: Options<DummyAData, ThrowOnError>): RequestResult<DummyAResponses, unknown, ThrowOnError> => options.client.get<DummyAResponses, unknown, ThrowOnError>({ url: '/api/v{api-version}/multiple-tags/a', ...options });

export const dummyB = <ThrowOnError extends boolean = false>(options: Options<DummyBData, ThrowOnError>): RequestResult<DummyBResponses, unknown, ThrowOnError> => options.client.get<DummyBResponses, unknown, ThrowOnError>({ url: '/api/v{api-version}/multiple-tags/b', ...options });

export const callWithResponse = <ThrowOnError extends boolean = false>(options: Options<CallWithResponseData, ThrowOnError>): RequestResult<CallWithResponseResponses, unknown, ThrowOnError> => options.client.get<CallWithResponseResponses, unknown, ThrowOnError>({ url: '/api/v{api-version}/response', ...options });

export const callWithDuplicateResponses = <ThrowOnError extends boolean = false>(options: Options<CallWithDuplicateResponsesData, ThrowOnError>): RequestResult<CallWithDuplicateResponsesResponses, CallWithDuplicateResponsesErrors, ThrowOnError> => options.client.post<CallWithDuplicateResponsesResponses, CallWithDuplicateResponsesErrors, ThrowOnError>({ url: '/api/v{api-version}/response', ...options });

export const callWithResponses = <ThrowOnError extends boolean = false>(options: Options<CallWithResponsesData, ThrowOnError>): RequestResult<CallWithResponsesResponses, CallWithResponsesErrors, ThrowOnError> => options.client.put<CallWithResponsesResponses, CallWithResponsesErrors, ThrowOnError>({ url: '/api/v{api-version}/response', ...options });

export const collectionFormat = <ThrowOnError extends boolean = false>(options: Options<CollectionFormatData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => options.client.get<unknown, unknown, ThrowOnError>({ url: '/api/v{api-version}/collectionFormat', ...options });
...
export const testErrorCode = <ThrowOnError extends boolean = false>(options: Options<TestErrorCodeData, ThrowOnError>): RequestResult<TestErrorCodeResponses, TestErrorCodeErrors, ThrowOnError> => options.client.post<TestErrorCodeResponses, TestErrorCodeErrors, ThrowOnError>({ url: '/api/v{api-version}/error', ...options });

export const nonAsciiæøåÆøÅöôêÊ字符串 = <ThrowOnError extends boolean = false>(options: Options<NonAsciiæøåÆøÅöôêÊ字符串Data, ThrowOnError>): RequestResult<NonAsciiæøåÆøÅöôêÊ字符串Responses, unknown, ThrowOnError> => options.client.post<NonAsciiæøåÆøÅöôêÊ字符串Responses, unknown, ThrowOnError>({ url: '/api/v{api-version}/non-ascii-æøåÆØÅöôêÊ字符串', ...options });
