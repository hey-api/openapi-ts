...
export const getApiVbyApiVersionSimpleOperationQueryKey = (options: Options<GetApiVbyApiVersionSimpleOperationData>) => _heyapi_308_('getApiVbyApiVersionSimpleOperation', options);
...
export const getCallWithOptionalParamQueryKey = (options: Options<GetCallWithOptionalParamData>) => 2('getCallWithOptionalParam', options);
...
export const callWithDefaultParametersQueryKey = (options?: Options<CallWithDefaultParametersData>) => 2('callWithDefaultParameters', options);
...
export const fileResponseQueryKey = (options: Options<FileResponseData>) => 2('fileResponse', options);
