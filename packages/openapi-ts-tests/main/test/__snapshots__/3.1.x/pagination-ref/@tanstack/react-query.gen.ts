...
export const getFooOptions = (options: Options<GetFooData> | typeof skipToken) => queryOptions<GetFooResponse, DefaultError, GetFooResponse, ReturnType<typeof getFooQueryKey>>({
    ...
    queryKey: getFooQueryKey(unwrapSkipToken(options) as Options<GetFooData>)
});
...
export const getFooInfiniteOptions = (options: Options<GetFooData> | typeof skipToken) => 
// @ts-ignore
infiniteQueryOptions<GetFooResponse, DefaultError, InfiniteData<GetFooResponse>, QueryKey<Options<GetFooData>>, number | null | Pick<QueryKey<Options<GetFooData>>[0], 'body' | 'headers' | 'path' | 'query'>>({
    ...
    queryKey: getFooInfiniteQueryKey(unwrapSkipToken(options) as Options<GetFooData>)
});
