...
export const serviceWithEmptyTagResource = <ThrowOnError extends boolean = false>(options?: () => Options<ServiceWithEmptyTagData, ThrowOnError> | undefined) => httpResource<unknown>(() => { const opts = options ? options() : undefined; return opts ? serviceWithEmptyTagRequest(opts) : undefined; });
...
export const callWithNoContentResponseResource = <ThrowOnError extends boolean = false>(options?: () => Options<CallWithNoContentResponseData, ThrowOnError> | undefined) => httpResource<unknown>(() => { const opts = options ? options() : undefined; return opts ? callWithNoContentResponseRequest(opts) : undefined; });
...
export const dummyAResource = <ThrowOnError extends boolean = false>(options?: () => Options<DummyAData, ThrowOnError> | undefined) => httpResource<unknown>(() => { const opts = options ? options() : undefined; return opts ? dummyARequest(opts) : undefined; });

export const dummyBResource = <ThrowOnError extends boolean = false>(options?: () => Options<DummyBData, ThrowOnError> | undefined) => httpResource<unknown>(() => { const opts = options ? options() : undefined; return opts ? dummyBRequest(opts) : undefined; });
 ...
 * Body should not be unknown
 */
export const postApiVbyApiVersionBodyResource = <ThrowOnError extends boolean = false>(options: () => Options<PostApiVbyApiVersionBodyData, ThrowOnError> | undefined) => httpResource<PostApiVbyApiVersionBodyResponse>(() => { const opts = options ? options() : undefined; return opts ? postApiVbyApiVersionBodyRequest(opts) : undefined; });
