...
export const callWithDefaultParametersQueryKey = (options: QueryKeyOptions<Options<CallWithDefaultParametersData>>) => createQueryKey('callWithDefaultParameters', options as Options<CallWithDefaultParametersData>);
