 ...
 * Send a single email
 */
export const sendEmail = <ThrowOnError extends boolean = false, TParseAs extends NonNullable<Config['parseAs']> = 'auto'>(options: Options<SendEmailData, ThrowOnError, SendEmailResponses, TParseAs>): RequestResult<SendEmailResponses, SendEmailErrors, ThrowOnError, 'fields', TParseAs> => (options.client ?? client).post<SendEmailResponses, SendEmailErrors, ThrowOnError, 'fields', TParseAs>({
    url: '/email',
    ...options,
    headers: {
