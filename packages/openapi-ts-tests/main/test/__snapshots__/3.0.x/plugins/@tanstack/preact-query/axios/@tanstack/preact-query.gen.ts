...
export const exportOptions = (options?: Options<ExportData> | typeof skipToken) => {
    ...
    return queryOptions<unknown, AxiosError<DefaultError>, unknown, ReturnType<typeof exportQueryKey>>({
...
export const apiVVersionODataControllerCountOptions = (options?: Options<ApiVVersionODataControllerCountData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<ApiVVersionODataControllerCountResponse, AxiosError<DefaultError>, ApiVVersionODataControllerCountResponse, ReturnType<typeof apiVVersionODataControllerCountQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
        ...
        queryKey: apiVVersionODataControllerCountQueryKey(opts)
    });
};
...
export const getApiVbyApiVersionSimpleOperationOptions = (options: Options<GetApiVbyApiVersionSimpleOperationData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<GetApiVbyApiVersionSimpleOperationResponse, AxiosError<GetApiVbyApiVersionSimpleOperationError>, GetApiVbyApiVersionSimpleOperationResponse, ReturnType<typeof getApiVbyApiVersionSimpleOperationQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
        ...
        queryKey: getApiVbyApiVersionSimpleOperationQueryKey(opts as Options<GetApiVbyApiVersionSimpleOperationData>)
    });
};
...
export const getCallWithoutParametersAndResponseOptions = (options?: Options<GetCallWithoutParametersAndResponseData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<unknown, AxiosError<DefaultError>, unknown, ReturnType<typeof getCallWithoutParametersAndResponseQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const getCallWithOptionalParamOptions = (options: Options<GetCallWithOptionalParamData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<unknown, AxiosError<DefaultError>, unknown, ReturnType<typeof getCallWithOptionalParamQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
        ...
        queryKey: getCallWithOptionalParamQueryKey(opts as Options<GetCallWithOptionalParamData>)
    });
};
...
export const getCallWithOptionalParamInfiniteOptions = (options: Options<GetCallWithOptionalParamData> | typeof skipToken) => {
    ...
    // @ts-ignore
    {
        ...
        queryKey: getCallWithOptionalParamInfiniteQueryKey(opts as Options<GetCallWithOptionalParamData>)
    });
};
...
export const callWithDefaultParametersOptions = (options?: Options<CallWithDefaultParametersData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<unknown, AxiosError<DefaultError>, unknown, ReturnType<typeof callWithDefaultParametersQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
        ...
        queryKey: callWithDefaultParametersQueryKey(opts)
    });
};
...
export const duplicateName2Options = (options?: Options<DuplicateName2Data> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<unknown, AxiosError<DefaultError>, unknown, ReturnType<typeof duplicateName2QueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const callWithNoContentResponseOptions = (options?: Options<CallWithNoContentResponseData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<CallWithNoContentResponseResponse, AxiosError<DefaultError>, CallWithNoContentResponseResponse, ReturnType<typeof callWithNoContentResponseQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const callWithResponseAndNoContentResponseOptions = (options?: Options<CallWithResponseAndNoContentResponseData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<CallWithResponseAndNoContentResponseResponse, AxiosError<DefaultError>, CallWithResponseAndNoContentResponseResponse, ReturnType<typeof callWithResponseAndNoContentResponseQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const dummyAOptions = (options?: Options<DummyAData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<DummyAResponse, AxiosError<DefaultError>, DummyAResponse, ReturnType<typeof dummyAQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const dummyBOptions = (options?: Options<DummyBData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<DummyBResponse, AxiosError<DefaultError>, DummyBResponse, ReturnType<typeof dummyBQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const callWithResponseOptions = (options?: Options<CallWithResponseData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<CallWithResponseResponse, AxiosError<DefaultError>, CallWithResponseResponse, ReturnType<typeof callWithResponseQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const collectionFormatOptions = (options: Options<CollectionFormatData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<unknown, AxiosError<DefaultError>, unknown, ReturnType<typeof collectionFormatQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const typesOptions = (options: Options<TypesData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<TypesResponse, AxiosError<DefaultError>, TypesResponse, ReturnType<typeof typesQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const fileResponseOptions = (options: Options<FileResponseData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<FileResponseResponse, AxiosError<DefaultError>, FileResponseResponse, ReturnType<typeof fileResponseQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
        ...
        queryKey: fileResponseQueryKey(opts as Options<FileResponseData>)
    });
};
...
export const complexTypesOptions = (options: Options<ComplexTypesData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<ComplexTypesResponse, AxiosError<DefaultError>, ComplexTypesResponse, ReturnType<typeof complexTypesQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
...
export const multipartResponseOptions = (options?: Options<MultipartResponseData> | typeof skipToken) => {
    const opts = options !== skipToken ? options : undefined;
    return queryOptions<MultipartResponseResponse, AxiosError<DefaultError>, MultipartResponseResponse, ReturnType<typeof multipartResponseQueryKey>>({
        queryFn: options === skipToken ? skipToken : async ({ queryKey, signal }) => {
        ...
        queryKey: multipartResponseQueryKey(opts)
    });
};
