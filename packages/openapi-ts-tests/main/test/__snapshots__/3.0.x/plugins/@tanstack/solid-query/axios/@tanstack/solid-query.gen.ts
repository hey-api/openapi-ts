...
export const deleteFooMutation = (options?: Partial<Options<DeleteFooData>>): MutationOptions<unknown, AxiosError<DefaultError>, Options<DeleteFooData>> => {
    const mutationOptions: MutationOptions<unknown, AxiosError<DefaultError>, Options<DeleteFooData>> = {
        mutationFn: async (fnOptions) => {
