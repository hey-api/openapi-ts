...
export const deleteFooMutation = (options: Options<DeleteFooData>): UseMutationOptions<unknown, Options<DeleteFooData>, Error> => {
    return {
        mutation: async (fnOptions) => {
