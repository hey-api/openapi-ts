 ...
 */
export type _400 = Brand<string, '400'>;
 ...
 * Fourth line
 */
export type CamelCaseCommentWithBreaks = Brand<number, 'CamelCaseCommentWithBreaks'>;
 ...
 * This is a simple string
 */
export type SimpleStringWithPattern = Brand<string, 'SimpleStringWithPattern'> | null;
...
export type DictionaryWithPropertiesAndAdditionalProperties = {
    foo?: Brand<number, 'DictionaryWithPropertiesAndAdditionalPropertiesFoo'>;
    bar?: boolean;
    [key: string]: Brand<string, 'DictionaryWithPropertiesAndAdditionalProperties'> | Brand<number, 'DictionaryWithPropertiesAndAdditionalProperties'> | boolean | undefined;
};
 ...
 */
export type ModelFromZendesk = Brand<string, 'ModelFromZendesk'>;
...
export type ModelWithNullableString = {
     ...
     * This is a simple string property
     */
    nullableProp1?: Brand<string, 'ModelWithNullableStringNullableProp1'> | null;
    /**
     * This is a simple string property
     */
    nullableRequiredProp1: Brand<string, 'ModelWithNullableStringNullableRequiredProp1'> | null;
    /**
     * This is a simple string property
     */
    nullableProp2?: Brand<string, 'ModelWithNullableStringNullableProp2'> | null;
    /**
     * This is a simple string property
     */
    nullableRequiredProp2: Brand<string, 'ModelWithNullableStringNullableRequiredProp2'> | null;
    /**
     * This is a simple enum with strings
     */
...
export type DeprecatedModel = {
     ...
     * @deprecated
     */
    prop?: Brand<string, 'DeprecatedModelProp'>;
};
...
export type CompositionWithOneOfAnonymous = {
    propA?: {
        propA?: Brand<string, 'CompositionWithOneOfAnonymousPropAPropA'>;
    } | Brand<string, 'CompositionWithOneOfAnonymousPropA'> | Brand<number, 'CompositionWithOneOfAnonymousPropA'>;
};
...
export type ModelCircle = {
    kind: Brand<string, 'ModelCircleKind'>;
    radius?: Brand<number, 'ModelCircleRadius'>;
};
...
export type ModelSquare = {
    kind: Brand<string, 'ModelSquareKind'>;
    sideLength?: Brand<number, 'ModelSquareSideLength'>;
};
...
export type CompositionWithAnyOfAnonymous = {
    propA?: {
        propA?: Brand<string, 'CompositionWithAnyOfAnonymousPropAPropA'>;
    } | Brand<string, 'CompositionWithAnyOfAnonymousPropA'> | Brand<number, 'CompositionWithAnyOfAnonymousPropA'>;
};
...
export type CompositionWithOneOfAndSimpleDictionary = {
    propA?: boolean | {
        [key: string]: Brand<number, 'CompositionWithOneOfAndSimpleDictionaryPropA'>;
    };
};
...
export type CompositionBaseModel = {
    firstName?: Brand<string, 'CompositionBaseModelFirstName'>;
    lastname?: Brand<string, 'CompositionBaseModelLastname'>;
};
...
export type CompositionExtendedModel = CompositionBaseModel & {
    age: Brand<number, 'CompositionExtendedModelAge'>;
    firstName: Brand<string, 'CompositionExtendedModelFirstName'>;
    lastname: Brand<string, 'CompositionExtendedModelLastname'>;
};
...
export type ModelWithProperties = {
    ...
    requiredAndNullable: Brand<string, 'ModelWithPropertiesRequiredAndNullable'> | null;
...
export type ModelWithNestedProperties = {
    readonly first: {
        readonly second: {
            readonly third: Brand<string, 'ModelWithNestedPropertiesFirstSecondThird'> | null;
        } | null;
    } | null;
};
...
export type File = {
     ...
     * Id
     */
    readonly id?: Brand<string, 'FileId'>;
    /**
     * Updated at
     */
    readonly updated_at?: Brand<string, 'FileUpdatedAt'>;
    /**
     * Created at
     */
    readonly created_at?: Brand<string, 'FileCreatedAt'>;
    /**
     * Mime
     */
    mime: Brand<string, 'FileMime'>;
    /**
     * File
     */
    readonly file?: Brand<string, 'FileFile'>;
};
...
export type Pageable = {
    page?: Brand<number, 'PageablePage'>;
    size?: Brand<number, 'PageableSize'>;
    sort?: Array<string>;
};
...
export type ModelWithAdditionalPropertiesEqTrue = {
     ...
     * This is a simple string property
     */
    prop?: Brand<string, 'ModelWithAdditionalPropertiesEqTrueProp'>;
    [key: string]: unknown;
};
...
export type CompositionWithOneOfAndProperties = ({
    ...
    baz: Brand<number, 'CompositionWithOneOfAndPropertiesBaz'> | null;
    qux: Brand<number, 'CompositionWithOneOfAndPropertiesQux'>;
};
...
export type NullableObject = {
    foo?: Brand<string, 'NullableObjectFoo'>;
} | null;

/**
 * Some % character
 */
export type CharactersInDescription = Brand<string, 'CharactersInDescription'>;
...
export type ModelWithOneOfEnum = {
    ...
    content: Brand<string, 'ModelWithOneOfEnumContent'>;
    foo: 'Quux';
} | {
    content: [
        string,
...
export type ModelWithReadOnlyAndWriteOnly = {
    foo: Brand<string, 'ModelWithReadOnlyAndWriteOnlyFoo'>;
    readonly bar: Brand<string, 'ModelWithReadOnlyAndWriteOnlyBar'>;
};
...
export type ModelWithAnyOfConstantSizeArray = [
    Brand<number, 'Items'> | Brand<string, 'Items'>,
    Brand<number, 'Items'> | Brand<string, 'Items'>,
    Brand<number, 'Items'> | Brand<string, 'Items'>
];
...
export type ModelWithAnyOfConstantSizeArrayNullable = [
    Brand<number, 'Items'> | null | Brand<string, 'Items'>,
    Brand<number, 'Items'> | null | Brand<string, 'Items'>,
    Brand<number, 'Items'> | null | Brand<string, 'Items'>
];

export type ModelWithAnyOfConstantSizeArrayWithNSizeAndOptions = [
    Brand<number, 'Items'> | Import,
    Brand<number, 'Items'> | Import
];
...
export type ModelWithBackticksInDescription = {
     ...
     * </pre>
     */
    template?: Brand<string, 'ModelWithBackticksInDescriptionTemplate'>;
};

export type ModelWithOneOfAndProperties = (SimpleParameter | NonAsciiStringæøåÆøÅöôêÊ字符串) & {
    baz: Brand<number, 'ModelWithOneOfAndPropertiesBaz'> | null;
    qux: Brand<number, 'ModelWithOneOfAndPropertiesQux'>;
};

/**
 * Model used to test deduplication strategy (unused)
 */
export type ParameterSimpleParameterUnused = Brand<string, 'ParameterSimpleParameterUnused'>;

/**
 * Model used to test deduplication strategy
 */
export type PostServiceWithEmptyTagResponse = Brand<string, 'PostServiceWithEmptyTagResponse'>;

/**
 * Model used to test deduplication strategy
 */
export type PostServiceWithEmptyTagResponse2 = Brand<string, 'PostServiceWithEmptyTagResponse2'>;

/**
 * Model used to test deduplication strategy
 */
export type DeleteFooData = Brand<string, 'DeleteFooData'>;

/**
 * Model used to test deduplication strategy
 */
export type DeleteFooData2 = Brand<string, 'DeleteFooData2'>;

/**
 * Model with restricted keyword name
 */
export type Import = Brand<string, 'Import'>;

export type SchemaWithFormRestrictedKeys = {
    description?: Brand<string, 'SchemaWithFormRestrictedKeysDescription'>;
    'x-enum-descriptions'?: Brand<string, 'SchemaWithFormRestrictedKeysXEnumDescriptions'>;
    'x-enum-varnames'?: Brand<string, 'SchemaWithFormRestrictedKeysXEnumVarnames'>;
    'x-enumNames'?: Brand<string, 'SchemaWithFormRestrictedKeysXEnumNames'>;
    title?: Brand<string, 'SchemaWithFormRestrictedKeysTitle'>;
    object?: {
        description?: Brand<string, 'SchemaWithFormRestrictedKeysObjectDescription'>;
        'x-enum-descriptions'?: Brand<string, 'SchemaWithFormRestrictedKeysObjectXEnumDescriptions'>;
        'x-enum-varnames'?: Brand<string, 'SchemaWithFormRestrictedKeysObjectXEnumVarnames'>;
        'x-enumNames'?: Brand<string, 'SchemaWithFormRestrictedKeysObjectXEnumNames'>;
        title?: Brand<string, 'SchemaWithFormRestrictedKeysObjectTitle'>;
    };
    array?: Array<{
        description?: Brand<string, 'Properties'>;
        'x-enum-descriptions'?: Brand<string, 'Properties'>;
        'x-enum-varnames'?: Brand<string, 'Properties'>;
        'x-enumNames'?: Brand<string, 'Properties'>;
        title?: Brand<string, 'Properties'>;
    }>;
};
...
export type IoK8sApimachineryPkgApisMetaV1Preconditions = {
     ...
     */
    resourceVersion?: Brand<string, 'IoK8sApimachineryPkgApisMetaV1PreconditionsResourceVersion'>;
    /**
     * Specifies the target UID.
     */
    uid?: Brand<string, 'IoK8sApimachineryPkgApisMetaV1PreconditionsUid'>;
};

export type AdditionalPropertiesUnknownIssue = {
    [key: string]: Brand<string, 'AdditionalPropertiesUnknownIssue'> | Brand<number, 'AdditionalPropertiesUnknownIssue'>;
};

export type AdditionalPropertiesUnknownIssue2 = {
    [key: string]: Brand<string, 'AdditionalPropertiesUnknownIssue2'> | Brand<number, 'AdditionalPropertiesUnknownIssue2'>;
};

export type AdditionalPropertiesUnknownIssue3 = Brand<string, 'AdditionalPropertiesUnknownIssue3'> & {
    entries: {
...
export type AdditionalPropertiesIntegerIssue = {
    value: Brand<number, 'AdditionalPropertiesIntegerIssueValue'>;
    [key: string]: Brand<number, 'AdditionalPropertiesIntegerIssue'>;
};
...
export type GenericSchemaDuplicateIssue1SystemBoolean = {
    item?: boolean;
    error?: Brand<string, 'GenericSchemaDuplicateIssue1SystemBooleanError'> | null;
...
export type GenericSchemaDuplicateIssue1SystemString = {
    item?: Brand<string, 'GenericSchemaDuplicateIssue1SystemStringItem'> | null;
    error?: Brand<string, 'GenericSchemaDuplicateIssue1SystemStringError'> | null;
    readonly hasError?: boolean;
};
...
export type ModelWithPropertiesWritable = {
    ...
    requiredAndNullable: Brand<string, 'ModelWithPropertiesWritableRequiredAndNullable'> | null;
...
export type FileWritable = {
     ...
     * Mime
     */
    mime: Brand<string, 'FileWritableMime'>;
};

export type ModelWithReadOnlyAndWriteOnlyWritable = {
    foo: Brand<string, 'ModelWithReadOnlyAndWriteOnlyWritableFoo'>;
    baz: Brand<string, 'ModelWithReadOnlyAndWriteOnlyWritableBaz'>;
};
...
export type AdditionalPropertiesUnknownIssueWritable = {
    [key: string]: Brand<string, 'AdditionalPropertiesUnknownIssueWritable'> | Brand<number, 'AdditionalPropertiesUnknownIssueWritable'>;
};
...
export type GenericSchemaDuplicateIssue1SystemBooleanWritable = {
    item?: boolean;
    error?: Brand<string, 'GenericSchemaDuplicateIssue1SystemBooleanWritableError'> | null;
    data?: {
        [key: string]: never;
    };
};
...
export type GenericSchemaDuplicateIssue1SystemStringWritable = {
    item?: Brand<string, 'GenericSchemaDuplicateIssue1SystemStringWritableItem'> | null;
    error?: Brand<string, 'GenericSchemaDuplicateIssue1SystemStringWritableError'> | null;
};

/**
 * This is a reusable parameter
 */
export type SimpleParameter = Brand<string, 'SimpleParameter'>;
...
export type GetApiVbyApiVersionSimpleOperationResponses = {
     ...
     */
    200: Brand<number, 'ApiVapiVersionSimpleOperationGet200'>;
};
...
export type PostCallWithOptionalParamResponses = {
     ...
     * Response is a simple number
     */
    200: Brand<number, 'ApiVapiVersionParametersPost200'>;
    /**
     * Success
     */
    204: void;
...
export type MultipartResponseResponses = {
    ...
    200: {
        file?: Blob | File;
        metadata?: {
            foo?: Brand<string, 'ApiVapiVersionMultipartGet200MetadataFoo'>;
            bar?: Brand<string, 'ApiVapiVersionMultipartGet200MetadataBar'>;
        };
    };
};
