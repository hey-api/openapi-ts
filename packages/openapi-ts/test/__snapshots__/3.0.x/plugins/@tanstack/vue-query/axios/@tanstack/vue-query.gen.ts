...
export const callWithDuplicateResponsesMutation = (options?: Partial<Options>) => {
    const mutationOptions: UseMutationOptions<CallWithDuplicateResponsesResponse, AxiosError<CallWithDuplicateResponsesError>, Options> = {
        mutationFn: async (localOptions) => {
            const { data } = await callWithDuplicateResponses({
                ...options,
                ...localOptions,
...
export const callWithResponsesMutation = (options?: Partial<Options>) => {
    const mutationOptions: UseMutationOptions<CallWithResponsesResponse, AxiosError<CallWithResponsesError>, Options> = {
        mutationFn: async (localOptions) => {
