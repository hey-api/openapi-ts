 ...
 * @throws ApiError
 */
export const parentModelWithDates = function (): Observable<ParentModelWithDatesResponse> {
 ...
 * @throws ApiError
 */
export const modelWithDates = function (): Observable<ModelWithDatesResponse> {
    return __request(OpenAPI, this.http, {
        method: 'PUT',
        url: '/api/model-with-dates',
 ...
 * @throws ApiError
 */
export const modelWithDatesArray = function (): Observable<ModelWithDatesArrayResponse> {
    return __request(OpenAPI, this.http, {
        method: 'PUT',
 ...
 * @throws ApiError
 */
export const arrayOfDates = function (): Observable<ArrayOfDatesResponse> {
    return __request(OpenAPI, this.http, {
        method: 'PUT',
 ...
 * @throws ApiError
 */
export const date = function (): Observable<DateResponse> {
    return __request(OpenAPI, this.http, {
        method: 'PUT',
        url: '/api/date'
    });
 ...
 * @throws ApiError
 */
export const multipleResponses = function (): Observable<MultipleResponsesResponse> {
    return __request(OpenAPI, this.http, {
        method: 'PUT',
