...
export const deleteCallWithoutParametersAndResponseMutation = (options?: Partial<Options>) => {
    const mutationOptions: MutationOptions<unknown, AxiosError<DefaultError>, Options> = {
        mutationFn: async (localOptions) => {
...
export const callWithDuplicateResponsesMutation = (options?: Partial<Options>) => {
    const mutationOptions: MutationOptions<CallWithDuplicateResponsesResponse, AxiosError<CallWithDuplicateResponsesError>, Options> = {
        mutationFn: async (localOptions) => {
            const { data } = await callWithDuplicateResponses({
                ...options,
                ...localOptions,
...
export const callWithResponsesMutation = (options?: Partial<Options>) => {
    const mutationOptions: MutationOptions<CallWithResponsesResponse, AxiosError<CallWithResponsesError>, Options> = {
        mutationFn: async (localOptions) => {
