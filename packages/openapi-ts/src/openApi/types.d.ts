import type { OpenApiV2_0_X, OpenApiV2_0_XTypes } from '~/openApi/2.0.x';
import type { OpenApiV3_0_X, OpenApiV3_0_XTypes } from '~/openApi/3.0.x';
import type { OpenApiV3_1_X, OpenApiV3_1_XTypes } from '~/openApi/3.1.x';
