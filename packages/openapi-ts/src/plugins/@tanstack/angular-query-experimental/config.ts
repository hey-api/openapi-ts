...
export const defaultConfig: Plugin.Config<TanStackAngularQueryPlugin> = {
  config: {
    case: 'camelCase',
    comments: true,
  ...
  handler: handler as Plugin.Handler<TanStackAngularQueryPlugin>,
  handlerLegacy: handlerLegacy as Plugin.Handler<TanStackAngularQueryPlugin>,
