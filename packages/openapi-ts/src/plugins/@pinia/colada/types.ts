...
export type UserConfig = Plugin.Name<'@pinia/colada'> &
  ...
  Plugin.UserExports & {
    ...
    case?: Casing;
    /**
     * Configuration for generated infinite query keys.
     *
     * See {@link https://pinia-colada.esm.dev/guide/infinite-queries.html Infinite Queries}
     *
     * Can be:
     ...
     *
     * See {@link https://pinia-colada.esm.dev/api/@pinia/colada/functions/useInfiniteQuery.html useInfiniteQuery}
     *
     * Can be:
     * - `boolean`: Shorthand for `{ enabled: boolean }`
     * - `string` or `function`: Shorthand for `{ name: string | function }`
...
export type Config = Plugin.Name<'@pinia/colada'> &
  ...
  Plugin.Exports & {
    ...
    case: Casing;
    /**
     * Resolved configuration for generated infinite query keys.
     *
     * See {@link https://pinia-colada.esm.dev/guide/infinite-queries.html Infinite Queries}
     */
