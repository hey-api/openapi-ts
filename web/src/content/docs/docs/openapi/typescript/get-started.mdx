...
[@hey-api/openapi-ts](https://github.com/hey-api/hey-api) generates TypeScript code from OpenAPI specifications. Point it at your spec, pick your plugins, and get production-grade code in seconds.
...
<InstallCommand packageName="@hey-api/openapi-ts" />
