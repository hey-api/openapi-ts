...
- **Read the documentation**. Start with the [Get Started](/docs/openapi/typescript/get-started) guide. If you find anything broken or confusing, you can suggest improvements by clicking "Edit" at the bottom of any page.

- **Browse open issues**. Help others by providing workarounds, asking for clarification, triaging, or suggesting labels on [open issues](https://github.com/hey-api/hey-api/issues). If you see something you would like to work on, consider opening a pull request.
...
- **Create a new issue**. If you can't find a solution, [open an issue](https://github.com/hey-api/hey-api/issues). The issue template will guide you through the process.
...
Ready to write some code? We have dedicated guides to help you [build](/docs/openapi/typescript/community/contributing/building), [develop](/docs/openapi/typescript/community/contributing/developing), and [test](/docs/openapi/typescript/community/contributing/testing) your feature before it's released.
