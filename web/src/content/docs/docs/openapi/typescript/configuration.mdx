...
<Tabs>
  <TabItem label="openapi-ts.config.ts">
```ts
...
```
  ...
  <TabItem label="openapi-ts.config.cjs">
```js
...
```
  ...
  <TabItem label="openapi-ts.config.mjs">
```js
/** @type {import('@hey-api/openapi-ts').UserConfig} */
export default {
  input: 'hey-api/backend', // sign up at app.heyapi.dev
...
The input can be a string path, URL, [API registry](/docs/openapi/typescript/configuration/input#api-registry) shorthand, an object containing any of these, or an object representing an OpenAPI specification. Hey API supports all valid OpenAPI versions and file formats.

You can learn more on the [Input](/docs/openapi/typescript/configuration/input) page.
...
You can learn more on the [Output](/docs/openapi/typescript/configuration/output) page.
...
You can learn more on the [Parser](/docs/openapi/typescript/configuration/parser) page.
...
You can learn more on the [Output](/docs/openapi/typescript/output) page.
...
You can view the complete list of options in the [UserConfig](https://github.com/hey-api/hey-api/blob/main/packages/openapi-ts/src/config/types.ts) interface.
