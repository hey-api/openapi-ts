...
:::caution
The validator feature is very limited. You can help improve it by submitting more [use cases](https://github.com/hey-api/hey-api/issues/1970#issuecomment-2933189789).
:::
