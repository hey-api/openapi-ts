...
- reads your existing [configuration](/docs/openapi/typescript/get-started) (or accepts inline config)
...
The plugin will automatically pick up your [configuration](/docs/openapi/typescript/configuration) file. You can also pass options inline using the `config` option:
